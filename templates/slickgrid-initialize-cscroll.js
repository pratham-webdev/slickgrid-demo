...
const slickgridTemplate = `${gridButtonsBar}<div id="myGrid" style="width:100%; height:80vh"></div><div class="plus-minus w-100 d-flex justify-content-end border border-top-0" style="background:#f5f6f7"><button class="btn btn-sm btn-outline-new m-2" onClick="plusGrid()">+</button><button class="btn btn-sm btn-outline-new m-2" onClick="minusGrid()">-</button></div>`
